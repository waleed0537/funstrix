...
! function(t, e) {
    ...
    const Ae = "tooltip",
        ...
        Le = {
            animation: !0,
            customStructure: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
            trigger: "hover focus",
            title: "",
            delay: 0,
            html: !1,
    ...
    class $e extends R {
        ...
        getTipElement() {
            ...
            const t = document.createElement("div");
            t.innerHTML = this._config.customStructure;
        ...
        _getConfig(t) {
            ...
            return Object.keys(e).forEach((t => {
                ...
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), h(Ae, t, this.constructor.DefaultType), t.sanitize && (t.customStructure = we(t.customStructure, t.allowList, t.sanitizeFn)), t
        }
        _getDelegateConfig() {
            const t = {};
    ...
    const Be = { ...$e.Default,
            ...
            trigger: "click",
            content: "",
            customStructure: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        },
        ze = { ...$e.DefaultType,
